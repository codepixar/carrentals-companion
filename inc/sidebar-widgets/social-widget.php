...
esc_html__( '[ CarRentals ] Social Widget', 'carrentals-companion' ),

// Widget description
array( 'description' => esc_html__( 'Add social content', 'carrentals-companion' ), ) 
);
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Follow Us', 'carrentals-companion' );
}
