...
esc_html__( '[ CarRentals ] Newsletter Form', 'carrentals-companion' ), 

// Widget description
array( 'description' => esc_html__( 'Add footer newsletter signup form.', 'carrentals-companion' ), ) 
);
...
<div id="mc_embed_signup" class="carrentals-subscribe-newsletter">
	<form target="_blank" novalidate action="<?php echo esc_url( $actionurl ); ?>" id="mc-embedded-subscribe-form" method="post" class="form-inline">
		<input type="email" name="EMAIL" placeholder="<?php esc_html_e( 'Email address', 'carrentals-companion' ); ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email address'" required>
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Newsletter', 'carrentals-companion' );
}
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'actionurl' ) ); ?>"><?php esc_html_e( 'Action URL:' ,'carrentals-companion'); ?></label> 
