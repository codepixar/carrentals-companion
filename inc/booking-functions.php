...
function carrentals_custom_init() {
    $args = array(
      'public' => false,
      'label'  => esc_html__( 'Car Booking', 'carrentals-companion' )
    );
...
function carrentals_admin_menu() {
    add_menu_page( esc_html__( 'Car Booking Lists', 'carrentals-companion' ), esc_html__( 'Car Booking', 'carrentals-companion' ), 'manage_options', 'carrental-car-booking', 'carrental_booking_admin_page', '
...
?>
    ...
    <div class="booking-settings-nav">
        <ul>
            <li class="tablist" ><?php esc_html_e( 'List', 'carrentals-companion' ); ?></li>
            <li class="tabsettings"><?php esc_html_e( 'Form Settings', 'carrentals-companion' ); ?></li>
        </ul>
    </div>
...
?>
<h2 style="text-align: center;"><?php esc_html_e( 'Settings', 'carrentals-companion' ); ?></h2>
<form action="#" method="post">
    
    <!-- Car model -->
    <div id="repeater">
        <div class="repeater-heading">
            <h5 class="pull-left"><?php esc_html_e( 'Car Model Settings', 'carrentals-companion' ); ?></h5>
            <span class="btn btn-primary pt-5 pull-right repeater-add-btn">
                <?php esc_html_e( 'Add Model Dropdown', 'carrentals-companion' ); ?>
            </span>
        </div>
        ...
        <div class="items" data-group="carmodel">
            ...
            <div class="item-content">
                <div class="form-group">
                    <label for="inputEmail" class="col-lg-2 control-label"><?php esc_html_e( 'Car Model', 'carrentals-companion' ); ?></label>
                    <div class="col-lg-10">
            ...
            <div class="pull-right repeater-remove-btn">
                ...
                <?php esc_html_e( 'Remove', 'carrentals-companion' ); ?>
                </span>
            </div>
            <div class="clearfix"></div>
        </div>
    ...
    <div id="pickup">
        <div class="repeater-heading">
            <h5 class="pull-left"><?php esc_html_e( 'Pickup Settings', 'carrentals-companion' ); ?></h5>
            <span class="btn btn-primary pt-5 pull-right repeater-add-btn">
            <?php esc_html_e( 'Add Pickup Dropdown', 'carrentals-companion' ); ?>
            </span>
        </div>
        <div class="clearfix"></div>
        ...
        <div class="items" data-group="pickup">
            ...
            <div class="item-content">
                <div class="form-group">
                    <label for="inputEmail" class="col-lg-2 control-label"><?php esc_html_e( 'Pickup', 'carrentals-companion' ); ?></label>
                    <div class="col-lg-10">
                        <input type="text" class="form-control" value="<?php echo $val; ?>" id="inputName" placeholder="Name" data-name="name">
                    </div>
                </div>
    ...
    <div id="dropoff">
        <div class="repeater-heading">
            <h5 class="pull-left"><?php esc_html_e( 'Drop Off Settings', 'carrentals-companion' ); ?></h5>
            <span class="btn btn-primary pt-5 pull-right repeater-add-btn">
            <?php esc_html_e( 'Add Drop off Dropdown', 'carrentals-companion' ); ?>
            </span>
        </div>
        <div class="clearfix"></div>
        ...
        <div class="items" data-group="dropoff">
            ...
            <div class="item-content">
                <div class="form-group">
                    <label for="inputEmail" class="col-lg-2 control-label"><?php esc_html_e( 'Drop Off', 'carrentals-companion' ); ?></label>
                    <div class="col-lg-10">
                        <input type="text" class="form-control" value="<?php echo $val; ?>" id="inputName" placeholder="Name" data-name="name">
                    </div>
                </div>
    ...
    <!-- drop off End -->
    <button type="submit" class="booking-submit" name="updateopt"><?php esc_html_e( 'Submit', 'carrentals-companion' ); ?></button>
</form>
<?php
}
...
function carrental_booking_lists() {
    ...
    if( $carmodel ) {
        echo '<li style="padding: 8px;background-color:#f8f8f8;">'.esc_html( $carmodel ).'<span style="margin-left: 30px;">'.esc_html( $pikdate ).'</span><span style="float:right;"><button class="view-booking" data-target="modal-'.esc_attr( $list->ID ).'" >'.esc_html__( 'View', 'carrentals-companion' ).'</button></span>'.carrental_booking_admin_modal( $list->ID ).'</li>';
    }
...
?>
    <div class="booking-modal modal-<?php echo esc_attr( $id ); ?>" style="position:absolute;top:0;background-color:#0003;top:0;bottom:0;left:0;right:0;display:none;">
        ...
        <div style="background-color: #f9f9f9;padding: 10px;max-width: 300px;margin: 0 auto;margin-top: 10%;">
            <h3 class="text-center"><?php esc_html_e( 'Car Booking Info', 'carrentals-companion' ) ?></h3>
            <ul class="modal-list">
                <li><strong><?php esc_html_e( 'Car Model:', 'carrentals-companion' ); ?></strong> <?php echo esc_html( $carmodel ); ?> </li>            
                <li><strong><?php esc_html_e( 'Pick Up Number:', 'carrentals-companion' ); ?></strong> <?php echo esc_html( $pickupnumber ); ?> </li>            
                <li><strong><?php esc_html_e( 'Pick Up Date:', 'carrentals-companion' ); ?></strong> <?php echo esc_html( $pikdate ); ?> </li>            
                <li><strong><?php esc_html_e( 'Drop Number:', 'carrentals-companion' ); ?></strong> <?php echo esc_html( $dropnumber ); ?> </li>            
                <li><strong><?php esc_html_e( 'Drop Date:', 'carrentals-companion' ); ?></strong> <?php echo esc_html( $dropdate ); ?> </li>            
                <li><strong><?php esc_html_e( 'Name:', 'carrentals-companion' ); ?></strong> <?php echo esc_html( $username ); ?> </li>            
                <li><strong><?php esc_html_e( 'Email:', 'carrentals-companion' ); ?> </strong><?php echo esc_html( $useremail ); ?> </li>            
                <li><strong><?php esc_html_e( 'Phone:', 'carrentals-companion' ); ?></strong> <?php echo esc_html( $userphone ); ?> </li>            
            </ul>
...
function carrental_booking_form_data() {
    ...
    if( isset( $_POST['booking_submit'] )  ) {
        ...
        if( ! empty( $_POST['carmodel'] ) ) {
            ...
            $error->add( 'field', __( 'Car model field can\'t be empty.', 'carrentals-companion' ) );
        }
        ...
        if( ! empty( $_POST['pickupNumber'] ) ) {
            ...
            $error->add( 'field', __( 'Pickup field can\'t be empty.', 'carrentals-companion' ) );
        }
        // 
        if( ! empty( $_POST['pikdate'] ) ) {
            $pikdate = $_POST['pikdate'];
        } else {
            $error->add( 'field', __( 'Pickup Date field can\'t be empty.', 'carrentals-companion' ) );
        }
        // 
        if( ! empty( $_POST['dropNumber'] ) ) {
            $dropnumber = $_POST['dropNumber'];
        } else {
            $error->add( 'field', __( 'Drop off field can\'t be empty.', 'carrentals-companion' ) );
        }
        ...
        if( ! empty( $_POST['dropdate'] ) ) {
            ...
            $error->add( 'field', __( 'Drop off date field can\'t be empty.', 'carrentals-companion' ) );
        }
        ...
        if( ! empty( $_POST['userName'] ) ) {
            ...
            $error->add( 'field', __( 'Name field can\'t be empty.', 'carrentals-companion' ) );
        }
        // 
        if( ! empty( $_POST['userEmail'] ) ) {
            $useremail = $_POST['userEmail'];
        } else {
            $error->add( 'field', __( 'Email field can\'t be empty.', 'carrentals-companion' ) );
        }
        // 
        if( ! empty( $_POST['userPhone'] ) ) {
            $userphone = $_POST['userPhone'];
        } else {
            $error->add( 'field', __( 'Phone number field can\'t be empty.', 'carrentals-companion' ) );
        }
...
function carrental_delete_booking() {
    ...
    if ( isset( $_POST['deletebooking'] ) && isset( $_POST['bookingid'] ) ) {
        ...
        if( $delete ) {
            echo '<h4 style="text-align:center;">'.esc_html__( 'Successfully Deleted', 'carrentals-companion' ).'</h4>';
        }
