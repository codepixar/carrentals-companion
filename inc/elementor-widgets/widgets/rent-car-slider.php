...
class CarRentals_Rent_Car_Slider extends Widget_Base {
	...
	public function get_title() {
		return __( 'Rent Car', 'carrentals-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'exibition_heading',
            [
                'label' => __( 'Section Heading', 'carrentals-companion' ),
            ]
        );
        $this->add_control(
            'sect_title', [
		...
		$this->start_controls_section(
			'exibition_content',
			[
				'label' => __( 'Rent Car', 'carrentals-companion' ),
			]
		);
		$this->add_control(
            'exibition_slider', [
                'label' => __( 'Create rent car', 'carrentals-companion' ),
                ...
                'fields' => [
                    ...
                    [
                        'name'  => 'price',
                        'label' => __( 'Price', 'carrentals-companion' ),
                        'type'  => Controls_Manager::TEXT,
                    ],
                    [
                        'name'  => 'priceunit',
                        'label' => __( 'Unit', 'carrentals-companion' ),
                        'type'  => Controls_Manager::TEXT,
                    ],
                    [
                        'name'  => 'btnlabel',
                        'label' => __( 'Button Label', 'carrentals-companion' ),
                        'type'  => Controls_Manager::TEXT,
                    ],
                    [
                        'name'  => 'btnurl',
                        'label' => __( 'Button Url', 'carrentals-companion' ),
        ...
        $this->add_control(
            'color_price', [
                'label'     => __( 'Price Color', 'carrentals-companion' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fab700',
                'selectors' => [
