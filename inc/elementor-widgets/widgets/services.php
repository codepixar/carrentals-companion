...
class CarRentals_Services extends Widget_Base {
	...
	public function get_title() {
		return __( 'Services', 'carrentals-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'services_heading',
            [
                'label' => __( 'Services Section Heading', 'carrentals-companion' ),
            ]
        );
        $this->add_control(
            'sect_title', [
		...
		$this->start_controls_section(
			'services_block',
			[
				'label' => __( 'Services', 'carrentals-companion' ),
			]
		);
		$this->add_control(
            'services_content', [
                'label' => __( 'Create Service', 'carrentals-companion' ),
                ...
                'fields' => [
                    ...
                    [
                        'name'  => 'url',
                        'label' => __( 'Title Url', 'carrentals-companion' ),
        ...
        $this->start_controls_section(
            'style_servicesbox', [
                'label' => __( 'Style Services Box', 'carrentals-companion' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'servicesbox_bgcolor',
            [
                'label'     => __( 'Style Service Box Background Color', 'carrentals-companion' ),
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Hover Service Box Background Color ', 'carrentals-companion' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
