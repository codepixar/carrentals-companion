...
class CarRentals_Team_Member extends Widget_Base {
	...
	public function get_title() {
		return __( 'Team Member', 'carrentals-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'team_sectcontent',
            [
                'label' => __( 'Team Section Top', 'carrentals-companion' ),
            ]
        );
        $this->add_control(
            'sect_title', [
                'label' => __( 'Title', 'carrentals-companion' ),
        ...
        $this->add_control(
            'sect_subtitle', [
                'label' => __( 'Sub Title', 'carrentals-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true
		...
		$this->start_controls_section(
			'team_memcontent',
			[
				'label' => __( 'Team Member', 'carrentals-companion' ),
			]
		);
		$this->add_control(
            'teamslider', [
                'label' => __( 'Create Team Member', 'carrentals-companion' ),
                'type' => Controls_Manager::REPEATER,
                'title_field' => '{{{ label }}}',
                'fields' => [
                    [
                        'name' => 'label',
                        'label' => __( 'Name', 'carrentals-companion' ),
                        'type' => Controls_Manager::TEXT,
                        'label_block' => true,
                        'default' => 'Name'
                    ],
                    [
                        'name' => 'desig',
                        'label' => __( 'Designation', 'carrentals-companion' ),
                        'type' => Controls_Manager::TEXT,
                    ],
                    [
                        'name' => 'img',
                        'label' => __( 'Photo', 'carrentals-companion' ),
                        'type' => Controls_Manager::MEDIA,
                    ],
                    [
                        'name' => 'fburl',
                        'label' => __( 'Facebook Url', 'carrentals-companion' ),
                        'type' => Controls_Manager::URL,
                        'show_external' => false,
                    ],
                    [
                        'name' => 'twiturl',
                        'label' => __( 'Twitter Url', 'carrentals-companion' ),
                        'type' => Controls_Manager::URL,
                        'show_external' => false,
                    ],
                    [
                        'name' => 'pinturl',
                        'label' => __( 'Pinterest Url', 'carrentals-companion' ),
                        'type' => Controls_Manager::URL,
                        'show_external' => false,
                    ],
                    [
                        'name' => 'driburl',
                        'label' => __( 'Dribbble Url', 'carrentals-companion' ),
                        'type' => Controls_Manager::URL,
                        'show_external' => false,
                    ],
                ],
        ...
        $this->add_control(
            'color_secttitle', [
                'label'     => __( 'Section Title Color', 'carrentals-companion' ),
        ...
        $this->add_control(
            'color_sectsubtitle', [
                'label'     => __( 'Section Sub Title Color', 'carrentals-companion' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#777',
                'selectors' => [
		...
		$this->start_controls_section(
			'style_teaminfo', [
				'label' => __( 'Style Team Member Info', 'carrentals-companion' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
        $this->add_control(
            'team_imghov',
            [
                'label' => __( 'Member Image Hover Color', 'carrentals-companion' ),
        ...
        $this->add_control(
            'team_nameopt',
            [
                'label' => __( 'Name Style', 'carrentals-companion' ),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_control(
            'color_name', [
                'label' => __( 'Name Color', 'carrentals-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'team_desigopt',
            [
                'label' => __( 'Designation Style', 'carrentals-companion' ),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_control(
            'color_desigopt', [
                'label' => __( 'Designation Color', 'carrentals-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'team_iconopt',
            [
                'label' => __( 'Icon Style', 'carrentals-companion' ),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_control(
            'color_iconopt', [
                'label' => __( 'Icon Color', 'carrentals-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
		...
		$this->add_control(
			'color_iconhovopt', [
				'label' => __( 'Icon Hover Color', 'carrentals-companion' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
        ...
        $this->add_control(
            'typography_iconopt',
            [
                'label' => __( 'Icon Font Size', 'carrentals-companion' ),
