...
class CarRentals_Counter extends Widget_Base {
	...
	public function get_title() {
		return __( 'Counter', 'carrentals-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'counter_content',
            [
                'label' => __( 'Counter', 'carrentals-companion' ),
            ]
        );
        $this->add_control(
            'counter', [
                'label' => __( 'Create Counter', 'carrentals-companion' ),
                ...
                'fields' => [
                    ...
                    [
                        'name'    => 'number',
                        'label'   => __( 'Number', 'carrentals-companion' ),
                        'type'    => Controls_Manager::TEXT,
                        'default' => '2536'
                    ]
                ],
        ...
        $this->start_controls_section(
            'style_counter', [
                'label' => __( 'Style Counter', 'carrentals-companion' ),
        ...
        $this->add_control(
            'color_number', [
                'label'     => __( 'Number Color', 'carrentals-companion' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
