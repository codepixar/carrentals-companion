 ...
 */
    ...
    function carrentals_meta_scripts() {
        wp_enqueue_style( 'carrentals-meta-style', plugins_url( 'assets/css/carrentals-meta.css', __FILE__ ) );
        wp_enqueue_script( 'carrentals-meta-script', plugins_url( 'assets/js/carrentals-meta.js', __FILE__ ), array('jquery'), '1.0', true );
    }
    ...
    function carrentals_add_custom_meta_box() {
        ...
        add_meta_box("pageheader-meta-box", esc_html__( "Builder Page Header Settings", 'carrentals-companion' ), "carrentals_bpheader_meta_box_markup", "page", "side", "high", null);
    }
    ...
    ?>
        <div class="header-opt header-show-opt">
            <p class="post-attributes-label-wrapper">
                <label for="pageheader-dropdown" class="post-attributes-label"><?php esc_html_e( 'Select Page Header', 'carrentals-companion' ); ?></label>
            </p>
            <?php 
            ...
            <select name="bpheadershow" class="carrentals-admin-selectbox" id="page_header_selectbox">
                <option value="show" <?php echo esc_attr( $val == 'show' ? 'selected' : '' ); ?>><?php esc_html_e( 'Show', 'carrentals-companion' ); ?></option>
                <option value="hide" <?php echo esc_attr( $val == 'hide' ? 'selected' : '' ); ?> ><?php esc_html_e( 'Hide', 'carrentals-companion' ); ?></option>
            </select>

        </div>
        <div class="header-opt header-img">
            <p class="post-attributes-label-wrapper">
                <label for="pageheader-dropdown" class="post-attributes-label"><?php esc_html_e( 'Set Page Header Background', 'carrentals-companion' ); ?></label>
            </p>
            <?php 
            ...
            <select name="bpheaderimg" class="carrentals-admin-selectbox" id="page_header_bg_selectbox">
                <option value="customize" <?php echo esc_attr( $val == 'customize' ? 'selected' : '' ); ?>><?php esc_html_e( 'From Customize', 'carrentals-companion' ); ?></option>
                <option value="featured" <?php echo esc_attr( $val == 'featured' ? 'selected' : '' ); ?> ><?php esc_html_e( 'Featured Image', 'carrentals-companion' ); ?></option>
            </select>
